...
Usage: #definition
* url = Canonical(EV-DRE)
* identifier[+]
  * system = "https://flute.com/EvidenceVariable"
  * value = "DRE"
* name = "DRE"
* title = "Study variable: Digital rectal examination results"
* status = #draft
* description = "Study variable regarding the digital rectal examination results of the patient for a prostatic cancer."
...
* insert Characteristic([[dre]], [[The results of DRE (normal or suspicious)]], [[The expression to retrieve the result of DRE from observation interpretation]])