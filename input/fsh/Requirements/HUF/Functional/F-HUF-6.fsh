...
* description = "Support for federated Support Vector Machines (SVM)."
* actor = "https://flute.com/ActorDefinition/AD-FLUTEPlatform"
* statement[+].key = "F-HUF-6"
* statement[=].label = "As a FLUTE platform, I SHOULD support federated Support Vector Machines (SVM)."
* statement[=].conformance = #SHOULD
* statement[=].requirement = "support federated Support Vector Machines (SVM)"
