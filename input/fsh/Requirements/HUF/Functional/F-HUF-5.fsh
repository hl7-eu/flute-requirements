...
* description = "Support for federated Random Forests (RF)."
* actor = "https://flute.com/ActorDefinition/AD-FLUTEPlatform"
* statement[+].key = "F-HUF-5"
* statement[=].label = "As a FLUTE platform, I SHOULD support federated Random Forests (RF)."
* statement[=].conformance = #SHOULD
* statement[=].requirement = "support federated Random Forests (RF)"
