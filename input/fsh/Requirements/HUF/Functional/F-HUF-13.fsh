...
* description = "Support for federated Diffusion models."
* actor = "https://flute.com/ActorDefinition/AD-FLUTEPlatform"
* statement[+].key = "F-HUF-13"
* statement[=].label = "As a FLUTE platform, I SHOULD support federated Diffusion models."
* statement[=].conformance = #SHOULD
* statement[=].requirement = "support federated Diffusion models"
