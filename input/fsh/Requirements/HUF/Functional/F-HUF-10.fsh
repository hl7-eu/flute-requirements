...
* description = "Support for federated Grid Optimization."
* actor = "https://flute.com/ActorDefinition/AD-FLUTEPlatform"
* statement[+].key = "F-HUF-10"
* statement[=].label = "As a FLUTE platform, I SHOULD support federated Grid Optimization."
* statement[=].conformance = #SHOULD
* statement[=].requirement = "support federated Grid Optimization"
