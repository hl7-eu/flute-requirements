...
* description = "Support for federated Decision Trees (DT)."
* actor = "https://flute.com/ActorDefinition/AD-FLUTEPlatform"
* statement[+].key = "F-HUF-4"
* statement[=].label = "As a FLUTE platform, I SHOULD support federated Decision Trees (DT)."
* statement[=].conformance = #SHOULD
* statement[=].requirement = "support federated Decision Trees (DT)"
