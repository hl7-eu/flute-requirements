...
* description = "VP shall be provided for each cohort in the MRI report."
* statement[+].key = "F-PIL-31"
* statement[=].label = "VP SHALL be provided for each cohort in the MRI report."
* statement[=].conformance = #SHALL
* statement[=].requirement = "be provided for each cohort in the MRI report"
