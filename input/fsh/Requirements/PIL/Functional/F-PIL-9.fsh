...
* description = "Data shall be labelled with class csPCa 0 or 1."
* statement[+].key = "F-PIL-9"
* statement[=].label = "Data SHALL be labelled with class csPCa 0 or 1."
* statement[=].conformance = #SHALL
* statement[=].requirement = "be labelled with class csPCa 0 or 1"
