...
* description = "The platform SHALL be able to train BCN1 and BCN2 models from an augmented/balanced datasets thanks to synthetic data."
* actor = "https://flute.com/ActorDefinition/AD-FLUTEPlatform"
* statement[+].key = "F-PIL-26"
* statement[=].label = "As a FLUTE platform, I SHALL be able to train BCN1 and BCN2 models from an augmented/balanced datasets thanks to synthetic data."
* statement[=].conformance = #SHALL
* statement[=].requirement = "be able to train BCN1 and BCN2 models from an augmented/balanced datasets thanks to synthetic data"
