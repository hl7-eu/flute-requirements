...
* description = "Platform shall allow the AI researchers to search for the relevant dataset."
* actor = "https://flute.com/ActorDefinition/AD-FLUTEPlatform"
* statement[+].key = "F-PIL-18"
* statement[=].label = "As a FLUTE platform, I SHALL allow the AI researchers to search for the relevant dataset."
* statement[=].conformance = #SHALL
* statement[=].requirement = "allow the AI researchers to search for the relevant dataset"
