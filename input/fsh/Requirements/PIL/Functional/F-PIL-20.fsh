...
* description = "Platform shall allow authentication of authorized individuals from Data owners and Data Users and varied level of access, based on their defined roles."
* actor = "https://flute.com/ActorDefinition/AD-FLUTEPlatform"
* statement[+].key = "F-PIL-20"
* statement[=].label = "As a FLUTE platform, I SHALL allow authentication of authorized individuals from Data owners and Data Users and varied level of access, based on their defined roles."
* statement[=].conformance = #SHALL
* statement[=].requirement = "allow authentication of authorized individuals from Data owners and Data Users and varied level of access, based on their defined roles"
