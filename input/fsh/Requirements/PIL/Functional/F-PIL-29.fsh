...
* description = "PSA shall be provided for each cohort."
* statement[+].key = "F-PIL-29"
* statement[=].label = "Type of biopsy SHALL be provided for each cohort."
* statement[=].conformance = #SHALL
* statement[=].requirement = "be provided for each cohort"
