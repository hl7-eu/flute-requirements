...
* description = "Lesions detected in mpMRI/bpMRI shall have to be reported using the Prostate Imaging-Report and Data System (PI-RADS) in version 2.0 or higher."
* statement[+].key = "F-PIL-3"
* statement[=].label = "Lesions detected in mpMRI/bpMRI SHALL have to be reported using the Prostate Imaging-Report and Data System (PI-RADS) in version 2.0 or higher."
* statement[=].conformance = #SHALL
* statement[=].requirement = "have to be reported using the Prostate Imaging-Report and Data System (PI-RADS) in version 2.0 or higher"
