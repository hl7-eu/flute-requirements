...
* description = "Access to local FLUTE nodes shall be Controlled/restricted."
* statement[+].key = "F-PIL-12"
* statement[=].label = "Access to local FLUTE nodes SHALL be Controlled/restricted."
* statement[=].conformance = #SHALL
* statement[=].requirement = "be Controlled/restricted"
