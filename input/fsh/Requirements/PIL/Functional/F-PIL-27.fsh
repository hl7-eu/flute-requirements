...
* description = "Age shall be provided at time of biopsy."
* statement[+].key = "F-PIL-27"
* statement[=].label = "Age SHALL be provided at time of biopsy."
* statement[=].conformance = #SHALL
* statement[=].requirement = "be provided at time of biopsy"
