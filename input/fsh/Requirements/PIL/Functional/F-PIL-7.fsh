...
* description = "Clinical data and MRI (both raw and processed) shall be linked."
* statement[+].key = "F-PIL-7"
* statement[=].label = "Clinical data and MRI (both raw and processed) SHALL be linked."
* statement[=].conformance = #SHALL
* statement[=].requirement = "be linked"
