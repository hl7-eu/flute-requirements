...
* description = "Cohorts shall consist of men with clinical suspicion of PCa based on a PSA > 3.0 ng/ml and/or abnormal DRE."
* statement[+].key = "F-PIL-2"
* statement[=].label = "Cohorts SHALL consist of men with clinical suspicion of PCa based on a PSA > 3.0 ng/ml and/or abnormal DRE."
* statement[=].conformance = #SHALL
* statement[=].requirement = "consist of men with clinical suspicion of PCa based on a PSA > 3.0 ng/ml and/or abnormal DRE"
