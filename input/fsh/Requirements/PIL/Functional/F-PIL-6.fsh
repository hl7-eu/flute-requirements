...
* description = "Input data shall be anonymized or pseudonymized."
* statement[+].key = "F-PIL-6"
* statement[=].label = "Input data SHALL be anonymized or pseudonymized."
* statement[=].conformance = #SHALL
* statement[=].requirement = "be anonymized or pseudonymized"
