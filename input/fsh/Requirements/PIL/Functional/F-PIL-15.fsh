...
* description = "The performance  of the model shall be higher than the BCN1 and BCN2 models."
* statement[+].key = "F-PIL-15"
* statement[=].label = "The performance  of the model SHALL be higher than the BCN1 and BCN2 models."
* statement[=].conformance = #SHALL
* statement[=].requirement = "be higher than the BCN1 and BCN2 models"
