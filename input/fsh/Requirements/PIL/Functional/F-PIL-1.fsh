...
* description = "mpMRI/bpMRI shall be performed within 1 year prior to the prostate biopsy."
* statement[+].key = "F-PIL-1"
* statement[=].label = "mpMRI/bpMRI SHALL be performed within 1 year prior to the prostate biopsy."
* statement[=].conformance = #SHALL
* statement[=].requirement = "be performed within 1 year prior to the prostate biopsy"
