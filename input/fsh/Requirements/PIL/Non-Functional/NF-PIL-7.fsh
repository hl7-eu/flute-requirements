...
* description = "Platform shall display terms and conditions of use (T&C) and Privacy policy."
* actor = "https://flute.com/ActorDefinition/AD-FLUTEPlatform"
* statement[+].key = "NF-PIL-7"
* statement[=].label = "As a FLUTE platform, I SHALL display terms and conditions of use (T&C) and Privacy policy."
* statement[=].conformance = #SHALL
* statement[=].requirement = "display terms and conditions of use (T&C) and Privacy policy"
