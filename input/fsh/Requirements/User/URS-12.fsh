...
* statement[+].key = "URS-12"
* statement[=].label = "The exchange of data between data owner nodes and central aggregator SHOULD follow the principle of data minimization. Only sharing the necessary data to be able to train models effectively."
* statement[=].conformance = #SHOULD
* statement[=].requirement = "follow the principle of data minimization"
