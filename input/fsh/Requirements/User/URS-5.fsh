...
* statement[+].key = "URS-5"
* statement[=].label = "Personal and sensitive data should not be used in the model training. In case it is required it should be properly protected, for example, with anonymization."
* statement[=].conformance = #SHOULD
* statement[=].requirement = "not be used in the model training or be properly protected"
