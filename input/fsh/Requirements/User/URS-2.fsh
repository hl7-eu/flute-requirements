...
* statement[+].key = "URS-2"
* statement[=].label = "Central aggregation of models should not leak any information of the data used to train local models."
* statement[=].conformance = #SHOULD
* statement[=].requirement = "not leak any information of the data used to train local models"
