...
* description = "Users whose data is part in the training of a model should be protected to data reconstruction attacks."
* actor = "https://flute.com/ActorDefinition/AD-User"
* statement[+].key = "URS-6"
* statement[=].label = "As a User, I SHOULD be protected to data reconstruction attacks if my data is part in the training of a model."
* statement[=].conformance = #SHOULD
* statement[=].requirement = "be protected to data reconstruction attacks if my data is part in the training of a model"
