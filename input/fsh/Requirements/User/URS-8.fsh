...
* description = "Users whose data is part if the training of a model should be protected to property inference attacks."
* actor = "https://flute.com/ActorDefinition/AD-User"
* statement[+].key = "URS-8"
* statement[=].label = "As a User, I SHOULD be protected to property inference attacks if my data is part in the training of a model."
* statement[=].conformance = #SHOULD
* statement[=].requirement = "be protected to property inference attacks if my data is part in the training of a model"
