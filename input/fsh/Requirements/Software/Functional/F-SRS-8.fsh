...
* description = "FLUTE platform should log every use of the data."
* actor = "https://flute.com/ActorDefinition/AD-FLUTEPlatform"
* statement[+].key = "F-SRS-8"
* statement[=].label = "As a FLUTE platform, I SHOULD log every use of the data."
* statement[=].conformance = #SHOULD
* statement[=].requirement = "log every use of the data"
