...
* description = "Platform should have password policies."
* actor = "https://flute.com/ActorDefinition/AD-FLUTEPlatform"
* statement[+].key = "NF-SRS-1"
* statement[=].label = "As a FLUTE platform, I SHOULD have password policies."
* statement[=].conformance = #SHOULD
* statement[=].requirement = "have password policies"
